...
export default function ContactForm() {
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    setLoading(true);
    setError(null);
    setSent(false); // Сбрасываем предыдущее состояние успеха
    ...
    try {
      ...
      setSent(true);
      setError(null); // Явно убираем ошибку при успехе
        ...
        <div className="grid gap-8 md:grid-cols-2 items-center">
          <div>
            ...
            <p className="mt-2 text-brand-gray">
              Укажите контактный номер и кратко опишите проблему.
            </p>
          </div>
          ...
          <form onSubmit={onSubmit} className="card p-6">
            ...
            <input
              required
              className="mt-1 w-full rounded-lg bg-black/50 border border-white/10 p-3"
              name="name"
              placeholder="Алексей"
            />
            ...
            <textarea
              ...
              name="comment"
              rows={4}
              placeholder="Что случилось с авто?"
            />
            ...
            {sent && (
              <div className="mt-3 text-brand-yellow">
